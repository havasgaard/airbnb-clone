    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-y-10 px-32 py-14 bg-gray-100 text-gray-600">
            ...
            <div className="space-y-4 text-xs text-gray-800">
                ...
                <p className="cursor-pointer">BASHAREACT</p>
            </div>
            <div className="space-y-4 text-xs text-gray-800">
                <h5 className="font-bold">HOST</h5>
                <p className="cursor-pointer">Flabasha</p>
                <p className="cursor-pointer">Presents</p>
                <p className="cursor-pointer">Airbnb</p>
                <p className="cursor-pointer">Clone</p>
            </div>
            <div className="space-y-4 text-xs text-gray-800">
                ...
                <p className="cursor-pointer">Over at Discord</p>
                <p className="cursor-pointer">https://discord.gg/NHjFZTsCM8</p>
            </div>
